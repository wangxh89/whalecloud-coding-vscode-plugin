...
export class Logger implements ILogger {
    ...
    constructor(logLevelName: string, globalStorageUri: vscode.Uri) {
        ...
        this.logChannel = vscode.window.createOutputChannel("浩鲸智能编程助手");
        ...
        this.logFilePath = this.getLogFilePath("whalecloud-codingplus");
    ...
    private async writeLine(message: string, level: LogLevel = LogLevel.Normal): Promise<void> {
        ...
        if (this.logLevel !== LogLevel.None) {
            ...
            try {
                ...
                console.log(`Error writing to whalecloud-codingplus log file: ${err}`);
            } finally {
